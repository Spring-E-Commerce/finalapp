        ...
        <div id="content">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <img class="img-profile rounded-circle" src="../../css/cam.jpg">
                        </a>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <br>
                        <div class="col-sm-4">
                            <a href="addForm" ><i class="fas fa-plus-circle" style="font-size: 38px"></i></a>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <table class="table table-hover">
                                <thead>
                                <tr style="background-color: #446AD8 " class="tr1" >
                                    <th>Name</th>
                                    <th>Title</th>
                                    <th>Image</th>
                                    <th>Price</th>
                                ...
                                <tr>
                                    ...
                                    <td><a class="btn btn-danger"
                                           href="delete?id=${p.id}" ><i class="fas fa-trash-alt"></i></a></td>
                                </tr>
                                </c:forEach>
                                </tbody>
                            </table>
